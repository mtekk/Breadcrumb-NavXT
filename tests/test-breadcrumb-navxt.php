...
class BreadcrumbNavXTTest extends WP_UnitTestCase {
	...
	function test_bcn_display()
	{
		...
		$this->assertSame('<span property="itemListElement" typeof="ListItem"><span property="name" class="home">' . get_option('blogname')
			...
			. '</span><meta property="url" content="' . get_term_link($this->terms[5]) . '"><meta property="position" content="6"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name" class="class="post post-post current-item">' . get_the_title($this->posts[0])
		...
		$this->assertSame('<span property="itemListElement" typeof="ListItem"><span property="name" class="class="post post-post current-item"">' . get_the_title($this->posts[0])
		...
		$this->assertSame('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to ' . get_option('blogname') . '." href="' . get_home_url() . '" class="home" ><span property="name">' . get_option('blogname')
			...
			. '</span></a><meta property="position" content="6"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name" class="class="post post-post current-item"">' . get_the_title($this->posts[0])
			. '</span><meta property="url" content="' . get_the_permalink($this->posts[0]) . '"><meta property="position" content="7"></span>'
			, bcn_display(true, true, false, true));
	}
	function test_bcn_display_list()
	{
		...
		$this->assertSame('<li class="post post-post current-item"><span property="itemListElement" typeof="ListItem"><span property="name" class="post post-post current-item">' . get_the_title($this->posts[0])
			...
			. '</span><meta property="url" content="' . get_term_link($this->terms[8]). '"><meta property="position" content="2"></span></li>'. "\n" . '<li class="taxonomy category"><span property="name" class="taxonomy category">' . get_term($this->terms[7])->name
