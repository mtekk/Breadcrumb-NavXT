...
if(function_exists('wp_is_serving_rest_request') && wp_is_serving_rest_request() && isset($block->context['postId']) && current_user_can('read_post', absint($block->context['postId'])))
{
