<?php
/**
 * This file contains tests for the mtekk_adminKit setting_int class
 *
 * @group adminKit
 * @group bcn_core
 */
class adminKitSettingIntTest extends WP_UnitTestCase {
	public $settings = array();
	function setUp() {
		parent::setUp();
		$this->settings['normal_setting'] = new \mtekk\adminKit\setting\setting_int(
				'normal_setting',
				42,
				'Normal Setting');
		$this->settings['empty_ok_setting'] = new \mtekk\adminKit\setting\setting_int(
				'empty_ok_setting',
				42,
				'Empty Ok Setting',
				true);
		$this->settings['deprecated_setting'] = new \mtekk\adminKit\setting\setting_int(
				'deprecated_setting',
				30,
				'Deprecated Setting',
				false,
	...
	function test_set_deprecated() {
		$new_setting = new \mtekk\adminKit\setting\setting_int(
				'normal_setting',
				42,
				'Normal Setting',
				false);
	...
	function test_get_opt_name() {
		$this->assertSame('i' . $this->settings['normal_setting']->get_name(), $this->settings['normal_setting']->get_opt_name());
	}
	function test_maybe_update_from_form_input() {
		$input = array('inormal_setting' => 45, 'inormal_settinga' => 423);
		$input_notthere = array('inormal_settinga' => 53, 'iabnormal_setting' => 33);
		//Test allowing empty
