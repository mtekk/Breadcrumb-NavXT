...
class adminKitSettingIntTest extends WP_UnitTestCase {
	...
	function setUp() {
		parent::setUp();
		$this->settings['normal_setting'] = new mtekk_adminKit_setting_int(
				'normal_setting',
				42,
				'Normal Setting');
		$this->settings['empty_ok_setting'] = new mtekk_adminKit_setting_int(
				'empty_ok_setting',
				42,
				'Empty Ok Setting',
				true);
		$this->settings['deprecated_setting'] = new mtekk_adminKit_setting_int(
				'deprecated_setting',
				30,
				'Deprecated Setting',
				false,
	...
	function test_setDeprecated() {
		$new_setting = new mtekk_adminKit_setting_int(
				'normal_setting',
				42,
				'Normal Setting',
				false);
